...
from image_service.resources import UploadLinkResource, UploadFileResource, DownloadFileResource
...
api_bp.add_resource(DownloadFileResource, 'download_file/<string:name>/')